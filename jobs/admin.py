...
from .models import UserProfile, ResumeAnalysis, CareerAnalysis, CandidateEmbedding, JobEmbedding, JobRecommendationRun, JobRecommendation, Job, Application, Interview
...
admin.site.register(JobRecommendationRun)
